...
// Mobile-only viewport-level bottom sheet — a real draggable sheet (drag the handle down, or
// fling it, to dismiss; spring physics via motion's drag gesture). Used by 'panel' mode as the
// small-screen fallback for the dedicated Reel viewer's desktop side panel
// (ReelCommentsAdjacentPanel). The Home Reels feed uses ReelInlineCommentsSheet instead, which
// is scoped to the Reel container itself rather than the viewport, at every breakpoint.
